...
// ArtistMusicList just requieres an browseID ans Params
...
func TestArtistMusicList(t *testing.T) {
	...
	result, err := browse.ArtistMusicList(browseID, params, &visitorID)
	if err != nil {
	...
	browseID = "UCoIOOL7QKuBhQHVKL8y7BEQ"
	params = "ggMCCAI%3D"
	result, err = browse.ArtistMusicList(browseID, params, nilVisitorID)
	if err != nil {
