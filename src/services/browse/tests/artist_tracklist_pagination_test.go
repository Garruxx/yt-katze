...
// ArtistTracklist just requieres an continuationID
// the visitorID is optional
func TestArtistTracklistPagination(t *testing.T) {
	...
	result, err := browse.ArtistTracklistPagination(continuationID, &visitorID)
	if err != nil {
	...
	continuationID = "4qmFsgJFEitWTE9MQUs1dXlfbkQwVjVmRklTVjl1TW12UFRGeEtJVERibUxVcUFNZVJZGhZlZ1pRVkRwRFIyZVNBUU1JdWdRJTNE"
	result, err = browse.ArtistTracklistPagination(continuationID, nilVisitorID)
	if err != nil {
