...
import (
	...
	"katze/src/mappers/search/utils/simplify/tests/data"
	"testing"
)
...
func TestMusicResponsiveListItemRenderer(t *testing.T) {
	...
	result, err := simplify.MusicResponsiveListItemRenderer(item)
	if err != nil {
	...
	_, err = simplify.MusicResponsiveListItemRenderer(item)
	if err == nil {
